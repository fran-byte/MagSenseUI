...
The variation (Δ) between consecutive measurements is used to classify magnetic disturbances:

- Δ ≤ 125 µT: Normal condition.
- Δ > 125 µT: `!` Warning. Small magnetic disturbance detected.
- Δ > 175 µT: `M` Magnetized. Significant magnetic disturbance detected.
